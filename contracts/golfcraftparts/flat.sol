...
// File contracts/GolfcraftParts_V2.sol
    ...
    ContextMixin
{
    ...
    bytes32 public constant GOLFLAND_MINTER_ROLE = keccak256("GOLFLAND_MINTER_ROLE");
    ...
    */
    ...
    /**
    * Override isApprovedForAll to auto-approve GolfLand minter contract
    */
    function isApprovedForAll(
        address _owner,
        address _operator
    ) public override view returns (bool isOperator) {
        // if GolfLand minter role is detected, auto-return true
       if (hasRole(GOLFLAND_MINTER_ROLE, _operator)) {
            return true;
        }
...
// File contracts/GolfcraftParts.sol
