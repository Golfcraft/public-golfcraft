...
export class GolfcraftParts__royaltyInfoResult {
  value0: Address;
  value1: BigInt;
...
export class GolfcraftParts extends ethereum.SmartContract {
  static bind(address: Address): GolfcraftParts {
    return new GolfcraftParts("GolfcraftParts", address);
  }
  ...
  GOLFLAND_MINTER_ROLE(): Bytes {
    let result = super.call(
      "GOLFLAND_MINTER_ROLE",
      "GOLFLAND_MINTER_ROLE():(bytes32)",
      []
    );
  ...
  try_GOLFLAND_MINTER_ROLE(): ethereum.CallResult<Bytes> {
    let result = super.tryCall(
      "GOLFLAND_MINTER_ROLE",
      "GOLFLAND_MINTER_ROLE():(bytes32)",
      []
  ...
  royaltyInfo(
    param0: BigInt,
    value: BigInt
  ): GolfcraftParts__royaltyInfoResult {
    let result = super.call(
      "royaltyInfo",
    ...
    return new GolfcraftParts__royaltyInfoResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_royaltyInfo(
    param0: BigInt,
    value: BigInt
  ): ethereum.CallResult<GolfcraftParts__royaltyInfoResult> {
    let result = super.tryCall(
      "royaltyInfo",
      "royaltyInfo(uint256,uint256):(address,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new GolfcraftParts__royaltyInfoResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
