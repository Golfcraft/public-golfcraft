...
const GetTitleData = (request:GetTitleDataRequest):Promise<GetTitleDataResult> => {
    return new Promise((resolve, reject)=>{
        PlayFabClient.GetTitleData(request, c(resolve, reject))
    })
}
